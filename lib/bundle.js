...
class Background {
  ...
  render () {
    ...
    this.context.drawImage(this.src,0,150,1800,450,this.xPos,0,canvWidth,canvHeight);
    this.context.drawImage(this.src,0,150,1800,450,this.xPos + canvWidth,0,canvWidth,canvHeight);
  ...
  render () {
    if (!this.gameOver) {
      ...
      this.enemies.forEach((enemy, i) => {
        ...
        if (i === this.enemies.length - 1 && enemy.xPos < 400) {
          spawnSignal = true;
        }
      })
